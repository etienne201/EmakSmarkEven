...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lister tous les lieux' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Modifier un lieu' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Supprimer un lieu' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
